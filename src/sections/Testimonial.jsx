...
const ReviewCardComponent = ({ img, name, username, body }) => {
  return (
    <figure
      className={twMerge(
        "relative h-full w-64 cursor-pointer overflow-hidden rounded-xl border p-4 border-gray-50/[.1] bg-gradient-to-r bg-indigo to-storm hover:bg-royal hover-animation gpu-layer"
      )}
    >
      <div className="flex flex-row items-center gap-2">
        <img
...
const Testimonial = React.memo(TestimonialComponent);
