...
const ProjectsComponent = () => {
  ...
  return (
    <section
      ...
      id="work"
    >
      <h2 className="text-heading gpu-layer">My Selected Projects</h2>
      <div className="mt-12 border-t border-black/10" />
      ...
      {preview && (
        <motion.img
          alt="Project Preview"
          className="fixed top-0 left-0 z-50 object-cover h-56 rounded-lg shadow-xl pointer-events-none w-80 border-4 border-white gpu-layer"
          src={preview}
          style={{ x: springX, y: springY }}
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
