...
const CreditLineComponent = ({ children }) => (
  <div className="relative overflow-hidden py-1 md:py-2">
    <h2 className="text-4xl md:text-7xl font-semibold text-text-primary gpu-layer">
      {children}
    </h2>
    <div className="text-mask absolute top-0 left-0 w-full h-full bg-background"></div>
  </div>
);
const CreditLine = React.memo(CreditLineComponent);
...
const Credits = React.memo(CreditsComponent);
export default Credits;
