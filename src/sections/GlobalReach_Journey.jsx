...
const GlobalReachJourneyComponent = () => {
  const sectionRef = useRef(null);
  ...
  return (
    ...
    >
      <div className="relative flex items-center w-full h-full">
        <div className="w-full h-full globe-container gpu-layer">
          <Globe />
        </div>
        <div className="absolute w-1/2 right-0 text-center text-background cta-container c-space gpu-layer">
          <h2 className="text-4xl font-bold md:text-6xl">
            Ready to build together?
          </h2>
          <p className="max-w-xl mx-auto mt-4 text-lg text-gray-300 md:text-xl">
...
const GlobalReachJourney = React.memo(GlobalReachJourneyComponent);
export default GlobalReachJourney;
