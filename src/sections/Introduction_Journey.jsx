...
const IntroductionJourneyComponent = () => {
  const sectionRef = useRef(null);
  ...
  return (
    ...
    >
      <div className="text-center max-w-4xl">
        <p className="subtext text-gray-400 intro-line gpu-layer">ABOUT ME</p>
        <h2 className="text-5xl md:text-7xl font-bold mt-4 intro-line gpu-layer">
          Hizkia Jonathan Budiana
        </h2>
        <p className="text-xl md:text-2xl text-gray-300 mt-8 intro-line gpu-layer">
          I’ve gone all-in on fullstack development—driven by deep focus,
          curiosity, and enthusiasm to build dynamic web and software apps that
          create real impact.
        </p>
...
const IntroductionJourney = React.memo(IntroductionJourneyComponent);
export default IntroductionJourney;
